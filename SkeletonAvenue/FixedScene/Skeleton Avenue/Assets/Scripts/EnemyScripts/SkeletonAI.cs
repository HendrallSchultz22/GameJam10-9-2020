...
public class SkeletonAI : MonoBehaviour
{
    ...
    [SerializeField] Transform hand, hand2;
    [SerializeField]
    ...
    public float navSeachRadius = 200;
    ...
    private Vector3 GetOffset()
    {
        ...
        float x = Random.Range(0, MaxPointOffset);
        float y = Random.Range(0, MaxPointOffset);
        float z = Random.Range(0, MaxPointOffset);
    ...
    public void Melee()
    {
        ...
        {
            PlayerStats PS = c.GetComponent<Collider>().gameObject.GetComponent<PlayerStats>();
            if (PS)
            {
                PS.DoDamage(CalculateDamage());
            }
        }
    }
